...
SRI SHA Hash
```text
sha384-2WUmaxffVQMsxhyLPRqpJILVoTmkwoPwsRIDClN8Tl1HUbmF6MkP1we7M+4+qDNa
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.738.0/index.min.mjs": "sha384-2WUmaxffVQMsxhyLPRqpJILVoTmkwoPwsRIDClN8Tl1HUbmF6MkP1we7M+4+qDNa"
        }
      }
    </script>
  </head>
