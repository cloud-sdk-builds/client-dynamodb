...
SRI SHA Hash
```text
sha384-y1vxvqMZzZzWYa/HMYtKYBRUEauAsWT8WYZh80RwK88FV45x5Pcjmawc6h7V8Jpo
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.564.0/index.min.mjs": "sha384-y1vxvqMZzZzWYa/HMYtKYBRUEauAsWT8WYZh80RwK88FV45x5Pcjmawc6h7V8Jpo"
        }
      }
    </script>
  </head>
