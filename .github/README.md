...
SRI SHA Hash
```text
sha384-nZusBeAzECpp8ozR//PL0ggydRNVp+kcearUerbAwVPeUPLlnnsseJxuh3eKzOTm
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.281.0/index.min.mjs": "sha384-nZusBeAzECpp8ozR//PL0ggydRNVp+kcearUerbAwVPeUPLlnnsseJxuh3eKzOTm"
        }
      }
    </script>
  </head>
