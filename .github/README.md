...
SRI SHA Hash
```text
sha384-s0GbwuQnmgCMm1dt5VNNfj/u2YQ+jiifO5u4mGY+55RAZc/W6uCuyOQ+k2EKCDOg
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.620.0/index.min.mjs": "sha384-s0GbwuQnmgCMm1dt5VNNfj/u2YQ+jiifO5u4mGY+55RAZc/W6uCuyOQ+k2EKCDOg"
        }
      }
    </script>
  </head>
