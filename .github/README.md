...
SRI SHA Hash
```text
sha384-ygtcS+oVVsdzoPyBPMAfg+Qq88ur8nJHu/mNXBqORirGR+9z9nmGOqoBwFULXR9a
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.474.0/index.min.mjs": "sha384-ygtcS+oVVsdzoPyBPMAfg+Qq88ur8nJHu/mNXBqORirGR+9z9nmGOqoBwFULXR9a"
        }
      }
    </script>
  </head>
