...
SRI SHA Hash
```text
sha384-5rQSE/BKDTG3+b0UxiZRN+DDJfksXQxhekiR3JAh+bkOL1Zy8CC6BdKMmVsZp2we
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.378.0/index.min.mjs": "sha384-5rQSE/BKDTG3+b0UxiZRN+DDJfksXQxhekiR3JAh+bkOL1Zy8CC6BdKMmVsZp2we"
        }
      }
    </script>
  </head>
