...
SRI SHA Hash
```text
sha384-ezldRD8YKtirRyZqw+AMyiUo+o1m4UA6DzHsjEFf8rjAT/t9rWdICQPkXFQAyOmt
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.622.0/index.min.mjs": "sha384-ezldRD8YKtirRyZqw+AMyiUo+o1m4UA6DzHsjEFf8rjAT/t9rWdICQPkXFQAyOmt"
        }
      }
    </script>
  </head>
