...
SRI SHA Hash
```text
sha384-Y7ezYeenjNzJsesgKck7gmwtXR7pN8RQPPQhWZhnUG+McFbMCWT2/9ufBwgb6+/P
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.430.0/index.min.mjs": "sha384-Y7ezYeenjNzJsesgKck7gmwtXR7pN8RQPPQhWZhnUG+McFbMCWT2/9ufBwgb6+/P"
        }
      }
    </script>
  </head>
