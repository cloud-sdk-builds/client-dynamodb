...
SRI SHA Hash
```text
sha384-hChqQ3wS8npcXdBAeyEJREA5GRRtYhvYFti5jZez/euFwpOv+wozSfaEL4y8CIil
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.504.0/index.min.mjs": "sha384-hChqQ3wS8npcXdBAeyEJREA5GRRtYhvYFti5jZez/euFwpOv+wozSfaEL4y8CIil"
        }
      }
    </script>
  </head>
