...
SRI SHA Hash
```text
sha384-+s9pRkqRbBEofjCEkw4gO5mHbtRASW1c7Qv/mR42PeTZ9mQMyhSmjJAkwcgIHXb/
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.772.0/index.min.mjs": "sha384-+s9pRkqRbBEofjCEkw4gO5mHbtRASW1c7Qv/mR42PeTZ9mQMyhSmjJAkwcgIHXb/"
        }
      }
    </script>
  </head>
