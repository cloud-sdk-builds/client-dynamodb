...
SRI SHA Hash
```text
sha384-U32smiKDIXutmHFgBb+B4x6JWUV2AfOePZLK2QhlkkhYPu+H9L/VvMnchPCkRadi
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.758.0/index.min.mjs": "sha384-U32smiKDIXutmHFgBb+B4x6JWUV2AfOePZLK2QhlkkhYPu+H9L/VvMnchPCkRadi"
        }
      }
    </script>
  </head>
