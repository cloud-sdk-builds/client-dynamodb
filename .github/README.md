...
SRI SHA Hash
```text
sha384-quEgm2400RSWDF1TkETaghQmtpL2CDhBhyz8cMxSDQmu+oievQSmpg6mQLzLbSI9
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.502.0/index.min.mjs": "sha384-quEgm2400RSWDF1TkETaghQmtpL2CDhBhyz8cMxSDQmu+oievQSmpg6mQLzLbSI9"
        }
      }
    </script>
  </head>
