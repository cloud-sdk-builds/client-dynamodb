...
SRI SHA Hash
```text
sha384-2DOOhfbR+R3HStlCw89WxcwwjA7fXemctiuinlioagNaFt0+Y/ZuOvdiKKhKSB3I
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.31.0/index.min.mjs": "sha384-2DOOhfbR+R3HStlCw89WxcwwjA7fXemctiuinlioagNaFt0+Y/ZuOvdiKKhKSB3I"
        }
      }
    </script>
  </head>
