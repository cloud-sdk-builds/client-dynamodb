...
SRI SHA Hash
```text
sha384-+E63vyVcsBE4BcdtKH+NvategMvBAasLBuUUj4rBYuOZn+i1ysbI3PUhIKIWGWUz
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.204.0/index.min.mjs": "sha384-+E63vyVcsBE4BcdtKH+NvategMvBAasLBuUUj4rBYuOZn+i1ysbI3PUhIKIWGWUz"
        }
      }
    </script>
  </head>
