...
SRI SHA Hash
```text
sha384-+vydScKiaYXf6QwuSu9gWnwn65SCHA+Wg0QjNKP7dfqvvGkc+rPU1+P/flw4BGhd
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.297.0/index.min.mjs": "sha384-+vydScKiaYXf6QwuSu9gWnwn65SCHA+Wg0QjNKP7dfqvvGkc+rPU1+P/flw4BGhd"
        }
      }
    </script>
  </head>
