...
SRI SHA Hash
```text
sha384-Uz5iWg+3vpZSPrZN2CWSbGoqVZkvrJJGOviLybmnpRbUpvwcfqCMALopzHFEsfgZ
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.590.0/index.min.mjs": "sha384-Uz5iWg+3vpZSPrZN2CWSbGoqVZkvrJJGOviLybmnpRbUpvwcfqCMALopzHFEsfgZ"
        }
      }
    </script>
  </head>
