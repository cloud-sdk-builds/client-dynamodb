...
SRI SHA Hash
```text
sha384-FV3xZFyPOGFA7OrTn7PahHO3D7Hm/7aY+80jpr6a2bN6+NOx0YTTIE2ENcOU8fSh
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.609.0/index.min.mjs": "sha384-FV3xZFyPOGFA7OrTn7PahHO3D7Hm/7aY+80jpr6a2bN6+NOx0YTTIE2ENcOU8fSh"
        }
      }
    </script>
  </head>
