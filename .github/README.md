...
SRI SHA Hash
```text
sha384-hgp+RFt8wqeepeTrkNajjlvibcN3kL6PN5DrYfS2GHBHQReGff3amlbWAeAsYdSE
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.872.0/index.min.mjs": "sha384-hgp+RFt8wqeepeTrkNajjlvibcN3kL6PN5DrYfS2GHBHQReGff3amlbWAeAsYdSE"
        }
      }
    </script>
  </head>
