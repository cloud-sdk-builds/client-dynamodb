...
SRI SHA Hash
```text
sha384-H3rODG/GcPdXaEUHtMrewnXjiYnQqhuRiLhpBCDRrvl8fwIOHJmJ+bzOZwZs9xgI
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.36.0/index.min.mjs": "sha384-H3rODG/GcPdXaEUHtMrewnXjiYnQqhuRiLhpBCDRrvl8fwIOHJmJ+bzOZwZs9xgI"
        }
      }
    </script>
  </head>
