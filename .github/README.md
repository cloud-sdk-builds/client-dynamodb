...
SRI SHA Hash
```text
sha384-NqPNvfGslVDpPLk9dYtmHJJnTrLBfU1DjODAUFGUGBXyOEsLSFkn8VaQtUD1c+pt
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.651.1/index.min.mjs": "sha384-NqPNvfGslVDpPLk9dYtmHJJnTrLBfU1DjODAUFGUGBXyOEsLSFkn8VaQtUD1c+pt"
        }
      }
    </script>
  </head>
