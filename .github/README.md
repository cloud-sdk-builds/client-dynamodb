...
SRI SHA Hash
```text
sha384-4foWt+DC73MCqK/idOEyOQHGUwwMu69V5bXu9CH8hJSRqKObrmDBnIYtxq5RHbc4
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.496.0/index.min.mjs": "sha384-4foWt+DC73MCqK/idOEyOQHGUwwMu69V5bXu9CH8hJSRqKObrmDBnIYtxq5RHbc4"
        }
      }
    </script>
  </head>
