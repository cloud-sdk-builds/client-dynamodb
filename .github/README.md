...
SRI SHA Hash
```text
sha384-58Uk8MLYqq8WdL3bwkpJinjg8BXYFFqzNW6HA3tJM4a/CHIRB2YTLVkoXR/07L1s
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.804.0/index.min.mjs": "sha384-58Uk8MLYqq8WdL3bwkpJinjg8BXYFFqzNW6HA3tJM4a/CHIRB2YTLVkoXR/07L1s"
        }
      }
    </script>
  </head>
