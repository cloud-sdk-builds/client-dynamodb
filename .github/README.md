...
SRI SHA Hash
```text
sha384-68YCbihIqSSyUqUV8vvDs95XMLOxgT8BTjIMabmktzVueUgrvd1+IP8wzCOmY0HX
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.395.0/index.min.mjs": "sha384-68YCbihIqSSyUqUV8vvDs95XMLOxgT8BTjIMabmktzVueUgrvd1+IP8wzCOmY0HX"
        }
      }
    </script>
  </head>
