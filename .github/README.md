...
SRI SHA Hash
```text
sha384-bQJz7eSYRixLoLVnwF5hsfmaSfyaxN/v3ihNDY0H9wIXTNDoTKtr+ZXUZT+bcM8n
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.168.0/index.min.mjs": "sha384-bQJz7eSYRixLoLVnwF5hsfmaSfyaxN/v3ihNDY0H9wIXTNDoTKtr+ZXUZT+bcM8n"
        }
      }
    </script>
  </head>
