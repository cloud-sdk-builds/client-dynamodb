...
SRI SHA Hash
```text
sha384-/HMQV0w4lkurra060+T7ErDVJpUAwSdUTuInh7qs5rKtcZzQWmmHAs8+QqUQS1+V
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.899.0/index.min.mjs": "sha384-/HMQV0w4lkurra060+T7ErDVJpUAwSdUTuInh7qs5rKtcZzQWmmHAs8+QqUQS1+V"
        }
      }
    </script>
  </head>
