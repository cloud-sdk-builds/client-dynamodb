...
SRI SHA Hash
```text
sha384-HuwhnErCZG3APMxWP+tbCKmmh1hT9nhQydiAAxqjOVKb5nR1PhGJXqFDBGzfwK8x
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.352.0/index.min.mjs": "sha384-HuwhnErCZG3APMxWP+tbCKmmh1hT9nhQydiAAxqjOVKb5nR1PhGJXqFDBGzfwK8x"
        }
      }
    </script>
  </head>
