...
```text
sha384-y6LHXkd5sEBH1uVyHdcKQOua3PX3D+3JcisAYssqQRcVkw2peQuv5Nr+3H/0P2b+
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.162.0/index.min.mjs": "sha384-y6LHXkd5sEBH1uVyHdcKQOua3PX3D+3JcisAYssqQRcVkw2peQuv5Nr+3H/0P2b+"
        }
      }
</script>
```
