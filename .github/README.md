...
SRI SHA Hash
```text
sha384-xHkkiwnd7ri9TehxKGZ8nyzzRKVdAhSpCvsVYNihugbRu0QuWgz4xYOZSvvu+jNd
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.370.0/index.min.mjs": "sha384-xHkkiwnd7ri9TehxKGZ8nyzzRKVdAhSpCvsVYNihugbRu0QuWgz4xYOZSvvu+jNd"
        }
      }
    </script>
  </head>
