...
SRI SHA Hash
```text
sha384-2HOx48MaBqBv/cH222f+o/caTisErXf6m6wdrjtxpUgZvJD2+LnyneGsRJFHgAHR
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.848.0/index.min.mjs": "sha384-2HOx48MaBqBv/cH222f+o/caTisErXf6m6wdrjtxpUgZvJD2+LnyneGsRJFHgAHR"
        }
      }
    </script>
  </head>
