...
```text
sha384-n1KupwQRUZaznZjEAWDcb7lgkrtD+/LaSpPxPXXtERPLqkEJ7rFgcv1cw2/KF8FS
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.22.0/index.min.mjs": "sha384-n1KupwQRUZaznZjEAWDcb7lgkrtD+/LaSpPxPXXtERPLqkEJ7rFgcv1cw2/KF8FS"
        }
      }
</script>
```
