...
SRI SHA Hash
```text
sha384-7aZ81vRHwMayHAB88BUexpCtpUTxgcvhY0CnT8NLIdA5eamZj+QgLNANMzrrDma+
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.51.0/index.min.mjs": "sha384-7aZ81vRHwMayHAB88BUexpCtpUTxgcvhY0CnT8NLIdA5eamZj+QgLNANMzrrDma+"
        }
      }
    </script>
  </head>
