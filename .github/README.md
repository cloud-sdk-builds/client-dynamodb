...
SRI SHA Hash
```text
sha384-7EeIPZRLnzvlh48kgNiDbs3IGJwCfhaSJCIoizvdAqCIjimnZYcSVI6Rh0yiqXE1
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.145.0/index.min.mjs": "sha384-7EeIPZRLnzvlh48kgNiDbs3IGJwCfhaSJCIoizvdAqCIjimnZYcSVI6Rh0yiqXE1"
        }
      }
    </script>
  </head>
