...
SRI SHA Hash
```text
sha384-s5dFBtn/+lkKhUAhA5O/9qDNTkpYSuxc6nK7OPczEzmfI3psuzzq/BgaPENLZpaI
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.835.0/index.min.mjs": "sha384-s5dFBtn/+lkKhUAhA5O/9qDNTkpYSuxc6nK7OPczEzmfI3psuzzq/BgaPENLZpaI"
        }
      }
    </script>
  </head>
