...
SRI SHA Hash
```text
sha384-QHWrsri4Tq/WTU1ApZ/VmSRmhTgZtaHXPr+7VySaWjHVLTQroVvqz7M7z+HhEgll
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.128.0/index.min.mjs": "sha384-QHWrsri4Tq/WTU1ApZ/VmSRmhTgZtaHXPr+7VySaWjHVLTQroVvqz7M7z+HhEgll"
        }
      }
    </script>
  </head>
