...
SRI SHA Hash
```text
sha384-msqEZMmBfT4jf8c2+r3aVzM9jAklcEELwWRYK/E1JJah/INLHC810DsmmHQiPrXt
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.975.0/index.min.mjs": "sha384-msqEZMmBfT4jf8c2+r3aVzM9jAklcEELwWRYK/E1JJah/INLHC810DsmmHQiPrXt"
        }
      }
    </script>
  </head>
