...
SRI SHA Hash
```text
sha384-obvUYYer6zulIEtyLbP3tfn0dSu0IrlGarbaoi57uRcQVb3n+l3zp1yomtzhln0R
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.25.0/index.min.mjs": "sha384-obvUYYer6zulIEtyLbP3tfn0dSu0IrlGarbaoi57uRcQVb3n+l3zp1yomtzhln0R"
        }
      }
    </script>
  </head>
