...
SRI SHA Hash
```text
sha384-bybJxVOFKuHhP+hCPcaDVf0TTSwAbpKrDz+p/OjyJwKJYXUdASa6iQiACPH+Td9l
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.741.0/index.min.mjs": "sha384-bybJxVOFKuHhP+hCPcaDVf0TTSwAbpKrDz+p/OjyJwKJYXUdASa6iQiACPH+Td9l"
        }
      }
    </script>
  </head>
