...
SRI SHA Hash
```text
sha384-lX05PLMYys/gYewdeVBc3XfWvwTmAOcKqmGoakySkZRrBunIqEZCAvDJ+ystXIAK
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.600.0/index.min.mjs": "sha384-lX05PLMYys/gYewdeVBc3XfWvwTmAOcKqmGoakySkZRrBunIqEZCAvDJ+ystXIAK"
        }
      }
    </script>
  </head>
