...
SRI SHA Hash
```text
sha384-QO+NK0kRFubsEdAltWuwcJRAS+N/Z5+p9+MC3mZn7hUjGu6Og1GrcIbrHCUwD4fc
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.2.0/index.min.mjs": "sha384-QO+NK0kRFubsEdAltWuwcJRAS+N/Z5+p9+MC3mZn7hUjGu6Og1GrcIbrHCUwD4fc"
        }
      }
    </script>
  </head>
