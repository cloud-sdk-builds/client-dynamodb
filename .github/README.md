...
SRI SHA Hash
```text
sha384-2N3F2T/f+wyDq3KKVzknIYUDnmQMAQV2uvZKmFhlo+H8ORUlvnyupEsy/SaBSTFA
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.294.0/index.min.mjs": "sha384-2N3F2T/f+wyDq3KKVzknIYUDnmQMAQV2uvZKmFhlo+H8ORUlvnyupEsy/SaBSTFA"
        }
      }
    </script>
  </head>
