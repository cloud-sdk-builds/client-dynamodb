...
SRI SHA Hash
```text
sha384-dvNnlqSJoby9upQxktpMnJMEhayCaiAmIlVlD7KcVeJ94L6cFXmr9oL20FiE//fn
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.895.0/index.min.mjs": "sha384-dvNnlqSJoby9upQxktpMnJMEhayCaiAmIlVlD7KcVeJ94L6cFXmr9oL20FiE//fn"
        }
      }
    </script>
  </head>
