...
SRI SHA Hash
```text
sha384-PPR9s4A9buerHWJSQxDe3W44+Fx8vrVU03QD8diJsNoyI7XetZielfA0zDE/PP8V
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.267.0/index.min.mjs": "sha384-PPR9s4A9buerHWJSQxDe3W44+Fx8vrVU03QD8diJsNoyI7XetZielfA0zDE/PP8V"
        }
      }
    </script>
  </head>
