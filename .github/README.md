...
SRI SHA Hash
```text
sha384-3lsaMtvFJf+tSRkkpmzeqzZ76LhGLfVppJpp5tgrs9Tujd1abnWZoztWw9kjb+S+
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.656.0/index.min.mjs": "sha384-3lsaMtvFJf+tSRkkpmzeqzZ76LhGLfVppJpp5tgrs9Tujd1abnWZoztWw9kjb+S+"
        }
      }
    </script>
  </head>
