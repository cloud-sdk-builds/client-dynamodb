...
SRI SHA Hash
```text
sha384-Se+iy0MosMRkimWDlNEOoP3CR8+qv9MVjkd5a0X16ICXnvqz1h8QbNfC4oC+oiJb
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.750.0/index.min.mjs": "sha384-Se+iy0MosMRkimWDlNEOoP3CR8+qv9MVjkd5a0X16ICXnvqz1h8QbNfC4oC+oiJb"
        }
      }
    </script>
  </head>
