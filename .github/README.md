...
SRI SHA Hash
```text
sha384-cj4wFX4+TwTASFxcwcUOh6X2oLGQdK2+z6xsucKbiPD5hrpVBgPqzpXQMOFqWODP
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.515.0/index.min.mjs": "sha384-cj4wFX4+TwTASFxcwcUOh6X2oLGQdK2+z6xsucKbiPD5hrpVBgPqzpXQMOFqWODP"
        }
      }
    </script>
  </head>
