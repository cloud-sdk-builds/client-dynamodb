...
SRI SHA Hash
```text
sha384-3Voa4vRYxIFzEm/lIPEJFqwwxRMfBhCaEk+Kna/RYOjX4+kGhKQ38usYCh/boE0/
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.947.0/index.min.mjs": "sha384-3Voa4vRYxIFzEm/lIPEJFqwwxRMfBhCaEk+Kna/RYOjX4+kGhKQ38usYCh/boE0/"
        }
      }
    </script>
  </head>
