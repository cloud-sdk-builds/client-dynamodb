...
SRI SHA Hash
```text
sha384-AFHaSxCTvMCsL7+2F+CBeqGbBpEs6+Pd0HMUDGRhG48pYSGNUBdwsDeVa2CJw6UB
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.954.0/index.min.mjs": "sha384-AFHaSxCTvMCsL7+2F+CBeqGbBpEs6+Pd0HMUDGRhG48pYSGNUBdwsDeVa2CJw6UB"
        }
      }
    </script>
  </head>
