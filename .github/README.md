...
SRI SHA Hash
```text
sha384-9pbrnx3hUx2WvzPKYTFUupXilLY4fFc9e5vZe+rvHaBEA+bMYonALd99kuLi+9IZ
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.37.0/index.min.mjs": "sha384-9pbrnx3hUx2WvzPKYTFUupXilLY4fFc9e5vZe+rvHaBEA+bMYonALd99kuLi+9IZ"
        }
      }
    </script>
  </head>
