...
SRI SHA Hash
```text
sha384-gY2+HSMP7lWTSz/cZKRrCPPk4ULLoRN2iux06zpjDWG9sxZB+8d8shECws9wlNSH
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.962.0/index.min.mjs": "sha384-gY2+HSMP7lWTSz/cZKRrCPPk4ULLoRN2iux06zpjDWG9sxZB+8d8shECws9wlNSH"
        }
      }
    </script>
  </head>
