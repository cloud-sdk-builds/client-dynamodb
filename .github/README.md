...
SRI SHA Hash
```text
sha384-+R9Mm9C3HdYnYltvGJyff0BcqrhKfSaFrpM0UlwQVwT7e4z+V8+tplNGr2viTHGx
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.933.0/index.min.mjs": "sha384-+R9Mm9C3HdYnYltvGJyff0BcqrhKfSaFrpM0UlwQVwT7e4z+V8+tplNGr2viTHGx"
        }
      }
    </script>
  </head>
