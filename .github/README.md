...
SRI SHA Hash
```text
sha384-yF0A1308nrEsrGTf7+NmzwpfdS7tv8Xv8X3V6GsOHkvIFpX5nk/9n+F3fYkjr5+r
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.34.0/index.min.mjs": "sha384-yF0A1308nrEsrGTf7+NmzwpfdS7tv8Xv8X3V6GsOHkvIFpX5nk/9n+F3fYkjr5+r"
        }
      }
    </script>
  </head>
