...
SRI SHA Hash
```text
sha384-9m1vT9gXmxpW5PCTGuOiLfW/FV+wHhyEZCJVKb0gvPCNSD29M24zw/fFc9+ED8k1
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.677.0/index.min.mjs": "sha384-9m1vT9gXmxpW5PCTGuOiLfW/FV+wHhyEZCJVKb0gvPCNSD29M24zw/fFc9+ED8k1"
        }
      }
    </script>
  </head>
