...
SRI SHA Hash
```text
sha384-scqGZcS1ssduElh45/9JAOP4fhnaDuB1wyzKWCapOAAPWOLbCeARNlCqoGtH5mfg
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.862.0/index.min.mjs": "sha384-scqGZcS1ssduElh45/9JAOP4fhnaDuB1wyzKWCapOAAPWOLbCeARNlCqoGtH5mfg"
        }
      }
    </script>
  </head>
