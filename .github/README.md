...
SRI SHA Hash
```text
sha384-kW4f/s/0HbqsuDzUyg1VM+vm436mV4X+WW9UYxm2cI+fBe4yHdxsWSTtuiAloSjE
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.968.0/index.min.mjs": "sha384-kW4f/s/0HbqsuDzUyg1VM+vm436mV4X+WW9UYxm2cI+fBe4yHdxsWSTtuiAloSjE"
        }
      }
    </script>
  </head>
