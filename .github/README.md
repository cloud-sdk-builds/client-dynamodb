...
SRI SHA Hash
```text
sha384-Fx3ZcRnh9Hp5Pq2LNIrm8EWc+VVNZqSUTxzAGx+u5xw7noQC1P1YBhHBB9v5zC1+
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.19.0/index.min.mjs": "sha384-Fx3ZcRnh9Hp5Pq2LNIrm8EWc+VVNZqSUTxzAGx+u5xw7noQC1P1YBhHBB9v5zC1+"
        }
      }
    </script>
  </head>
