...
SRI SHA Hash
```text
sha384-pDSkwes7s0XheQIddiVV0WLKifra0o1zwWOg0T2oAAYgvfl7j7p3+rzd4zvyuqDd
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.348.0/index.min.mjs": "sha384-pDSkwes7s0XheQIddiVV0WLKifra0o1zwWOg0T2oAAYgvfl7j7p3+rzd4zvyuqDd"
        }
      }
    </script>
  </head>
