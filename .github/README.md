...
SRI SHA Hash
```text
sha384-Y78MvuCseHF+0VgAWcDm9CAq9uzIaaOHqa+ys3V8NcUo3zwao91lk7z+DPM/jfi7
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.490.0/index.min.mjs": "sha384-Y78MvuCseHF+0VgAWcDm9CAq9uzIaaOHqa+ys3V8NcUo3zwao91lk7z+DPM/jfi7"
        }
      }
    </script>
  </head>
