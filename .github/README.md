...
SRI SHA Hash
```text
sha384-gPx+0DnGplvsyiad6Hcdt+kg0OBIelpcUOvTe9WNqabhzsnn9MgNQm3ZOdTitK8D
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.890.0/index.min.mjs": "sha384-gPx+0DnGplvsyiad6Hcdt+kg0OBIelpcUOvTe9WNqabhzsnn9MgNQm3ZOdTitK8D"
        }
      }
    </script>
  </head>
