...
SRI SHA Hash
```text
sha384-uADhOll/yu6Rtz074CeT7KfoKDRKKteV7qfKE5s/Ak3bvVvrMGd/jXPohw1D/5bn
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.786.0/index.min.mjs": "sha384-uADhOll/yu6Rtz074CeT7KfoKDRKKteV7qfKE5s/Ak3bvVvrMGd/jXPohw1D/5bn"
        }
      }
    </script>
  </head>
