...
[`@aws-sdk/client-dynamodb`](https://www.npmjs.com/package/@aws-sdk/client-dynamodb/v/3.1106.0).
...
- @aws-sdk/client-dynamodb v3.1106.0 - [https://cloud-sdk-builds.github.io/?sdk=client-dynamodb&version=3.1106.0](https://cloud-sdk-builds.github.io/?sdk=client-dynamodb&version=3.1106.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.1106.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VDIMzbexCbHFE0xZqf3VjOYyBsoyPnk4jvobLuYvG+QUkEkXwrDTE+zDEjEDX6kB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-dynamodb": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.1106.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.1106.0/index.min.mjs": "sha384-VDIMzbexCbHFE0xZqf3VjOYyBsoyPnk4jvobLuYvG+QUkEkXwrDTE+zDEjEDX6kB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-dynamodb/blob/refs/tags/3.1106.0/LICENSE
```
