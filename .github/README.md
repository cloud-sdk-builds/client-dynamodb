...
SRI SHA Hash
```text
sha384-13ouRZIDvnzJZkZ997QpcKVRBiXKevQt6NBTVu7/ZFuxaBnsRcFNKhCmxnK/wMMI
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.112.0/index.min.mjs": "sha384-13ouRZIDvnzJZkZ997QpcKVRBiXKevQt6NBTVu7/ZFuxaBnsRcFNKhCmxnK/wMMI"
        }
      }
    </script>
  </head>
