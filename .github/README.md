...
SRI SHA Hash
```text
sha384-Dg0V8xSJycQIzMvHfJ5CUAB7QqOz1mJJeSzSzPoJTEVlVd3zgi9syWV1GrBpPBOM
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.224.0/index.min.mjs": "sha384-Dg0V8xSJycQIzMvHfJ5CUAB7QqOz1mJJeSzSzPoJTEVlVd3zgi9syWV1GrBpPBOM"
        }
      }
    </script>
  </head>
