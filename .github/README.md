...
SRI SHA Hash
```text
sha384-EMtKCRFoTTIHSq9gt40F7+Ox2VB6+2eZ83GF0eQ+3Bm8znKyUGls/amCLZS97LJj
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.952.0/index.min.mjs": "sha384-EMtKCRFoTTIHSq9gt40F7+Ox2VB6+2eZ83GF0eQ+3Bm8znKyUGls/amCLZS97LJj"
        }
      }
    </script>
  </head>
