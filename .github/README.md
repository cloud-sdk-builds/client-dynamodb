...
SRI SHA Hash
```text
sha384-afWRxSrpWqQIz18UxrKfZylrhBpOWakevSV3UPXyBiXadme3SToWKrpRJtJQ9chz
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.279.0/index.min.mjs": "sha384-afWRxSrpWqQIz18UxrKfZylrhBpOWakevSV3UPXyBiXadme3SToWKrpRJtJQ9chz"
        }
      }
    </script>
  </head>
