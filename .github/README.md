...
SRI SHA Hash
```text
sha384-mDbbruAuugG97f4seRWCmgAPo3vn5n+yZaqGnGj+oEiHQJNYGLD0tTy98gFDSmfw
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.433.0/index.min.mjs": "sha384-mDbbruAuugG97f4seRWCmgAPo3vn5n+yZaqGnGj+oEiHQJNYGLD0tTy98gFDSmfw"
        }
      }
    </script>
  </head>
