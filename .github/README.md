...
SRI SHA Hash
```text
sha384-p+ZKDQsXvJodF7+hnPKYS6H0BH26EtTQZVekgIk6OCk4D8NPVLeM2NbGgSjqYwfg
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.137.0/index.min.mjs": "sha384-p+ZKDQsXvJodF7+hnPKYS6H0BH26EtTQZVekgIk6OCk4D8NPVLeM2NbGgSjqYwfg"
        }
      }
    </script>
  </head>
