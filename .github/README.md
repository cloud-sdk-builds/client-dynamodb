...
SRI SHA Hash
```text
sha384-3dMgpd0BaIYjlOTnTkvHmDRXOfOnIayc24t9QnzRgE+MLl4Xixw2hPdtcUaXLWql
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.80.0/index.min.mjs": "sha384-3dMgpd0BaIYjlOTnTkvHmDRXOfOnIayc24t9QnzRgE+MLl4Xixw2hPdtcUaXLWql"
        }
      }
    </script>
  </head>
