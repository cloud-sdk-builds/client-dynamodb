...
[`@aws-sdk/client-dynamodb`](https://www.npmjs.com/package/@aws-sdk/client-dynamodb/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.650.0/index.min.mjs
```

SRI SHA Hash
```text
sha384-H9OW/UmlnbfqNrg8gmMp52YTaWfhSrMqqahVkylNH5ofCuBKnuCVmgM9fM3AYpfH
```
...
<html>
  <head>
    <script type="importmap">
      {
        "imports": {
          "@aws-sdk/client-dynamodb": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.650.0/index.min.mjs"
        },
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dynamodb@3.650.0/index.min.mjs": "sha384-H9OW/UmlnbfqNrg8gmMp52YTaWfhSrMqqahVkylNH5ofCuBKnuCVmgM9fM3AYpfH"
        }
      }
    </script>
  </head>
...
```
https://github.com/cloud-sdk-builds/client-dynamodb/blob/refs/tags/3.650.0/LICENSE
```
